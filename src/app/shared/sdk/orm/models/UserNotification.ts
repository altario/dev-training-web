...
import { UserNotification, UserNotificationInterface, LoopBackFilter } from '../../models';
import { UserNotificationActions } from '../../actions';

export class OrmUserNotification extends OrmBase<UserNotification | UserNotificationInterface> {
  constructor(protected store: Store<UserNotification>, protected realTime?: RealTime) {
    super(store, UserNotification, UserNotificationActions, realTime);
  }
