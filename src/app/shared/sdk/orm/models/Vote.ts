...
import { Vote, VoteInterface, LoopBackFilter } from '../../models';
import { VoteActions } from '../../actions';

export class OrmVote extends OrmBase<Vote | VoteInterface> {
  constructor(protected store: Store<Vote>, protected realTime?: RealTime) {
    super(store, Vote, VoteActions, realTime);
  }
