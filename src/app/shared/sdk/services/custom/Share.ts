...
/**
 * Api services for the `Share` model.
 */
@Injectable()
export class ShareApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getPost(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Shares/:id/post";
    let _routeParams: any = {
  ...
  /**
   * Statistical information for 'Share' registers.
   *
