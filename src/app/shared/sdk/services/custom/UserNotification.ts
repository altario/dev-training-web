...
/**
 * Api services for the `UserNotification` model.
 */
@Injectable()
export class UserNotificationApi extends BaseLoopBackApi {
  ...
  public getOrganization(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/UserNotifications/:id/organization";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Statistical information for 'UserNotification' registers.
   *
