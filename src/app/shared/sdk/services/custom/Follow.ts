...
/**
 * Api services for the `Follow` model.
 */
@Injectable()
export class FollowApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getFollowee(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Follows/:id/followee";
    let _routeParams: any = {
  ...
  /**
   * Statistical information for 'Follow' registers.
   *
