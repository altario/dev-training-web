...
/**
 * Api services for the `Subscription` model.
 */
@Injectable()
export class SubscriptionApi extends BaseLoopBackApi {
  ...
  /**
   * Counts reports of Subscription.
   *
   * @param {any} id Subscription id
   *
  ...
  public countReports(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Subscriptions/:id/reports/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
