...
/**
 * Api services for the `Invite` model.
 */
@Injectable()
export class InviteApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getInvitedUser(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Invites/:id/invitedUser";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Statistical information for 'Invite' registers.
   *
